...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp"><i class="fa-solid fa-house-medical"></i> BHATIYA HOSPITAL</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <c:if  test="${empty userObj }">
         ...
         <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">APOTTMENT</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#"> VIEW APOTTMENT</a>
        </li>
